...
const SmartCanvasPage = lazy(() => import("./pages/smart-canvas-page"));
...
const ZimagePage = lazy(() => import("./pages/zimage"));
const KleinPage = lazy(() => import("./pages/klein"));
const AnglePage = lazy(() => import("./pages/angle"));
...
export const routeOption = defineRouteOption({
    ...
    routes: [
        ...
        { path: "smart-canvas/:id", element: lazyRouteElement(SmartCanvasPage) },
        ...
        { path: "online", element: lazyRouteElement(OnlinePage) },
        { path: "gpt-chat", element: lazyRouteElement(GptChatPage) },
        { path: "enhance", element: lazyRouteElement(EnhancePage) },
        { path: "zimage", element: lazyRouteElement(ZimagePage) },
        { path: "klein", element: lazyRouteElement(KleinPage) },
        { path: "angle", element: lazyRouteElement(AnglePage) },
    ],
    consoleMenus: [
