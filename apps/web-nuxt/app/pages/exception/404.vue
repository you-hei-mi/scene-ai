<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="relative w-full max-w-md">
      <div class="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl text-center">
        <div class="mb-6">
          <div class="w-24 h-24 mx-auto rounded-full bg-primary/20 flex items-center justify-center">
            <UIcon name="lucide:file-search" class="w-14 h-14 text-primary-light" />
          </div>
        </div>

        <h1 class="text-7xl font-bold text-white mb-2 tracking-tight">404</h1>
        <h2 class="text-xl font-semibold text-white mb-2">页面未找到</h2>
        <p class="text-slate-400 mb-8">
          您访问的页面不存在或已被移除。请检查链接是否正确，或返回首页浏览其他内容。
        </p>
